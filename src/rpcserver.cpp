...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Adirondack server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Adirondack server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Adirondack features */
        {"adirondack", "masternode", &masternode, true, true, false},
        {"adirondack", "masternodelist", &masternodelist, true, true, false},
        {"adirondack", "mnbudget", &mnbudget, true, true, false},
        {"adirondack", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"adirondack", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"adirondack", "mnsync", &mnsync, true, true, false},
        {"adirondack", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"adirondack", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use adirondackd, or the -server option to adirondack-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> adirondack-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22120/\n";
}
