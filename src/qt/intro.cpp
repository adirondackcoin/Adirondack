...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Adirondack Core"),
     ...
     * override -datadir in the adirondack.conf file in the default data directory
     * (to be consistent with adirondackd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
