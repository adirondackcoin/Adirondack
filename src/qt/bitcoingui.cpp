                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Adirondack Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Adirondack address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and adirondack: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Adirondack Core"), this);
    aboutAction->setStatusTip(tr("Show information about Adirondack Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Adirondack"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Adirondack addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Adirondack addresses"));
    ...
    openAction->setStatusTip(tr("Open a Adirondack: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Adirondack Core help message to get a list with possible Adirondack command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Adirondack Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Adirondack network", "", count));
}
...
{
    QString strTitle = tr("Adirondack Core"); // default title
