...
/** Utility functions used by the Adirondack Qt UI.
 */
namespace GUIUtil
{
...
// Render Adirondack addresses in monospace font
...
// Parse "adirondack:" URI into recipient object, return true on successful parsing
