...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Adirondack Core adirondack-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  adirondack-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded adirondack transaction") + "\n" +
                               "  adirondack-tx [options] -create [commands]   " + _("Create hex-encoded adirondack transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded adirondack transaction
