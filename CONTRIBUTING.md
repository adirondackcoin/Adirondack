Contributing to Adirondack Core
============================

The Adirondack Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Adirondack Core project, and is not to be
confused with overall Adirondack Network Protocol consensus changes.

Whether a pull request is merged into Adirondack Core rests with the project merge
...
Patches that change Adirondack consensus rules are considerably more involved than
...
Where a patch set proposes to change the Adirondack consensus, it must have been
...
The project leader is the release manager for each Adirondack Core release.
