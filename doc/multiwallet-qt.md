...
In order to support loading of multiple wallets in adirondack-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is adirondack.cpp.
...
Changes to adirondack.cpp
----------------------
adirondack.cpp is the entry point into adirondack-qt, and as such, will require some minor modifications to provide hooks for
