Adirondack Core version 2.2.1 is now available from:

  <https://github.com/adirondack-project/adirondack/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/adirondack-project/adirondack/issues>

Compatibility
==============

Adirondack Core is extensively tested on multiple operating systems using
...
Adirondack Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Adirondack was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/adirondack-project-translations/).
